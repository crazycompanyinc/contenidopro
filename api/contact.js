// Vercel serverless — ContenidoPro
let nodemailer;
try { nodemailer = require('nodemailer'); } catch(e) { nodemailer = null; }
const FROM = '"ContenidoPro" <crazycompanyincmail@gmail.com>';
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    if (type === 'lead') {
      await sendMail(t, { to: email, subject: 'Tus 20 prompts para crear contenido viral', text: 'Los mejores prompts para generar ideas, hooks y guiones que funcionan.\n\nAccede al sistema completo en: https://contenidopro.vercel.app' });
      return res.status(200).json({ ok: true });
    }
